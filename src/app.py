...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice teamwork and compete in inter-school soccer matches",
    ...
    "Drama Club": {
        "description": "Practice acting and put on stage performances",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["ella@mergington.edu", "lucas@mergington.edu"]
    },
    "Debate Team": {
        "description": "Learn public speaking and prepare for debate competitions",
